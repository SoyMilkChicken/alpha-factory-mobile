...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/backtest` | `/backtest` | `/(tabs)/companies` | `/companies` | `/(tabs)/` | `/(tabs)` | `/(tabs)/settings` | `/settings` | `/.DS_Store` | `/onboarding`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/companies/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/companies/[ticker]`;
